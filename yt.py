...
def to_connnect_api():
    Id="AIzaSyBwyoyvN9W7BjEdfUitEty0UeqF7pVJqQY"

    service="youtube"
    version="v3"

    youtube=build(service,version,developerKey=Id)

    return youtube

youtube=to_connnect_api()



def channel_info(chl_id):
    getting =youtube.channels().list(
                    part="snippet,ContentDetails,statistics",
                    id=chl_id
    )
    response=getting.execute()
...
def videos_IDS(chl_id):
    video_ids=[]
    response=youtube.channels().list(id=chl_id,
...
client=pymongo.MongoClient("mongodb+srv://prasadguru476:guruguvi@cluster0.2bxdgbi.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
